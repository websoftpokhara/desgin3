<html>
	...
	<body>
		<section id="topheader">
			<div class="container">
				<div class="row">
					<div class="col-md-4 left-topheader">
						Welcome to our shop
					</div>
					<div class="col-md-8 right-topheader">
			...
			<div class="container">
				<div class="row">
					...
					<div class="col-md-6 searchbox">
						<input type="text" name="search" placeholder="Type to search here ....">
						<button type="submit">
							<i class="fas fa-search"></i>
						</button>
					</div>
					<div class="col-md-3 logininfo">
						<i class="fa fa-user-alt"></i>
						<span class="logininfo-content">
